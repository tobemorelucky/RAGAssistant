...
def plan_retrieval_queries(question: str) -> Dict[str, Any]:
    ...
    system_prompt = (
        ...
        "For calculated or derived metrics, include underlying fields needed to compute or verify the metric. "
        "For margin, rate, or ratio questions, include likely numerator and denominator fields. "
        "For comparison questions, include field names and periods that may appear in tables. "
